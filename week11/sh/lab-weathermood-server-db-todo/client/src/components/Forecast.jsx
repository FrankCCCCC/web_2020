...
export default class Forecast extends React.Component {
        ...
        return (
            <div className='forecast'>
                ...
                <div className='todos'>
                    ...
                    <TodoList todos={todos} accomplishTodo={this.accomplishTodo} listMoreTodos={this.listMoreTodos} hasMore={this.state.hasMore}/>
                    {
                        todoLoading &&
    ...
    listMoreTodos() {
        // console.log('todo array length:', this.state.todos.length)
        // console.log('all the state:', this.state.todos)
