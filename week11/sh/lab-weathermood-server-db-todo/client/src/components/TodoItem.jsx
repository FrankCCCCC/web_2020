...
export default class TodoItem extends React.Component {
    ...
    render() {
        ...
        return (
            <div className={'todo-item d-flex flex-column ' + (doneTs !=='0' ? 'done' : 'undone')}  onClick={this.handleCheckboxCheck}>
                ...
                <div className='check d-flex justify-content-end align-items-center'>
                    ...
                    <div className='checkbox' >
                        <i className={'far ' + (doneTs !== '0' ? 'fa-check-square' : 'fa-square')} aria-hidden="true"></i>
                    </div>
                </div>
            </div>
        );
    ...
    handleCheckboxCheck(e) {
        console.log(`handle id's doneTs: ${this.props.doneTs}`);
        if (this.props.doneTs === '0') {
            console.log(`handle id: ${this.props.id}`);
